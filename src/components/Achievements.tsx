            ...
            >
              ...
              <div className="flex-1 flex flex-col md:flex-row md:items-center justify-between w-full px-4 md:px-0 z-10 transform transition-transform duration-500 group-hover:translate-x-2">
                ...
                >
                  ...
                  <h3 className="font-syne text-2xl md:text-5xl lg:text-6xl font-extrabold text-[#EDE7DC] uppercase tracking-tighter mb-4 group-hover:text-white transition-colors duration-500">
                    {award.event}
                  </h3>
