...
export const About = () => {
  ...
  return (
    <section ref={containerRef} id="about" className="relative min-h-[90vh] flex items-center overflow-hidden border-b border-[#EDE7DC]/13 py-32 md:py-40 bg-[#0A0C0E]">
      ...
      >
        <span className="font-syne text-[55vw] lg:text-[45vw] font-extrabold leading-[0.75] text-[#EDE7DC] opacity-[0.02] tracking-tighter m-0 p-0">
          02
        </span>
      </motion.div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 lg:px-24 w-full relative z-10 text-left">
        ...
        <div className="flex flex-col lg:flex-row justify-between w-full">
          ...
          <div className="lg:w-[58%] flex flex-col justify-start mb-20 lg:mb-0">
            ...
            <h2 className="font-syne text-4xl sm:text-5xl lg:text-[56px] leading-[1.1] font-extrabold text-[#EDE7DC] uppercase tracking-tighter mb-8 max-w-[650px] flex flex-col items-start">
              <motion.span 
                initial={{ opacity: 0, y: shouldReduceMotion ? 0 : 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: false, margin: "-10%" }}
